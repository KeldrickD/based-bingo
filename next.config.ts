      ...
      headers: [
        {
          ...
          value: [
            ...
            "connect-src 'self' https://farcaster.xyz https://client.farcaster.xyz https://warpcast.com https://client.warpcast.com https://wrpcd.net https://*.wrpcd.net https://privy.farcaster.xyz https://privy.warpcast.com https://auth.privy.io https://*.rpc.privy.systems https://cloudflareinsights.com https://mainnet.base.org https://*.base.org https://api.basescan.org https://*.coinbase.com https://*.coinbasewallet.com https://*.onchainkit.xyz",
